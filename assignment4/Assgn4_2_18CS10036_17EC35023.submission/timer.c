...
//static void get_timer_list(struct list* timer_wait, int64_t* tick_val);
...
timer_sleep (int64_t ticks) 
{
  ...
  //thread_wake_sl(&th, wakeup_inorder);  // Insert it with other threads
...
timer_interrupt (struct intr_frame *args UNUSED)
{
  ...
  // }
  //thread_wake(&timer_wait_list,ticks);
...
struct list * get_timer_list()
{
  return &timer_wait_list;
}
int64_t get_tick_val()
{
  return ticks;
}